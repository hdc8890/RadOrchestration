# CODE-REVIEW.md — Template Schema

> Created by the Reviewer Agent after each task. Evaluates code quality, architectural consistency, design adherence, and test coverage.
